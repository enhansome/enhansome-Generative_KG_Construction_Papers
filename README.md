...
* We release [DeepKE-LLM](https://github.com/zjunlp/DeepKE/tree/main/example/llm) ⭐ 4,479 | 🐛 0 | 🌐 Python | 📅 2026-07-13 to support **knowledge extraction** with [KnowLM](https://github.com/zjunlp/KnowLM) ⭐ 1,385 | 🐛 0 | 🌐 Python | 📅 2025-01-11, [ChatGLM](https://github.com/THUDM/ChatGLM-6B) ⭐ 40,960 | 🐛 605 | 🌐 Python | 📅 2024-06-27, LLaMA-series, GPT-series etc.
* We release [EasyEdit](https://github.com/zjunlp/EasyEdit) ⭐ 2,922 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-07-14, an easy-to-use framework to edit Large Language Models.
