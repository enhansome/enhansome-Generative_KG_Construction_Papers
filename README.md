...
* We release [DeepKE-LLM](https://github.com/zjunlp/DeepKE/tree/main/example/llm) ⭐ 4,462 | 🐛 0 | 🌐 Python | 📅 2026-07-13 to support **knowledge extraction** with [KnowLM](https://github.com/zjunlp/KnowLM) ⭐ 1,386 | 🐛 0 | 🌐 Python | 📅 2025-01-11, [ChatGLM](https://github.com/THUDM/ChatGLM-6B) ⭐ 40,992 | 🐛 607 | 🌐 Python | 📅 2024-06-27, LLaMA-series, GPT-series etc.
...
* We release a prompt\&KG paper-list at [PromptKG](https://github.com/zjunlp/PromptKG) ⭐ 735 | 🐛 1 | 🌐 Python | 📅 2024-03-22.
...
| [Unified Structure Generation for Universal Information Extraction](https://aclanthology.org/2022.acl-long.395/)                                                     | Structure-linearized |   ACL 2022  |               [UIE](https://github.com/universal-ie/UIE) ⭐ 957 \| 🐛 39 \| 🌐 Python \| 📅 2022-07-30              |
...
| [From Discrimination to Generation: Knowledge Graph Completion with Generative Transformer](https://dl.acm.org/doi/10.1145/3487553.3524238)                          | Structure-linearized |   WWW 2022  | [GenKGC](https://github.com/zjunlp/PromptKG/tree/main/research/GenKGC) ⭐ 735 \| 🐛 1 \| 🌐 Python \| 📅 2024-03-22 |
